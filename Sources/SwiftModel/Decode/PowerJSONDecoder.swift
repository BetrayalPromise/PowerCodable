...
public final class PowerJSONDecoder {
    public struct Strategy {
        ...
        public var key: PowerJSONDecoder.KeyDecodingStrategy = .useDefaultKeys
        ...
        public var nonConformingFloat: PowerJSONDecoder.NonConformingFloatDecodingStrategy = .zero
    }
...
extension PowerInnerJSONDecoder {
    ...
    func unbox<T>(object: JSON) throws -> T where T: BinaryFloatingPoint, T: LosslessStringConvertible {
        ...
        case let .string(string):
            switch self.wrapper?.strategy.nonConformingFloat ?? .zero {
            case .zero:
